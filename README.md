...
## Overview
<ul>
  <li><a href="#terraform-ibm-dedicated-host">terraform-ibm-dedicated-host</a></li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-dedicated-host/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-dedicated-host/tree/main/examples/advanced">Advanced example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-dedicated-host/tree/main/examples/basic">Basic example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-dedicated-host/tree/main/examples/upgrade">Upgraded example</a>
